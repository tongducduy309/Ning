( function( $ ) {
	...
	var wdtShopProducts = function($scope, $){
		...
		if($scope.hasClass('elementor-element-edit-mode')) {
			...
			var customCSS = jQuery('body', parent.document).find('style[id="faryita-woo-non-archive-inline-css"]').text();
			jQuery('body', parent.document).find('style[id="faryita-woo-non-archive-inline-css"]').remove();
			...
			var customJS = jQuery('body', parent.document).find('script[id="faryita-woo-non-archive-js-after"]').text();
			jQuery('body', parent.document).find('script[id="faryita-woo-non-archive-js-after"]').remove();
